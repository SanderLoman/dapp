...
const Header = () => {
    return (
        <div className="header-container flex flex-col md:flex-row items-center justify-evenly md:m-52 px-4 py-8">
            <div className="header-left flex flex-col items-center">
                ...
                <div className="header-links flex w-full items-center justify-evenly">
                    <a href="https://app.uniswap.org/#/swap" target="_blank"><img src={HeaderLink1} alt="Header link 1" /></a>
                    <a href="https://dexscreener.com/bsc/" target="_blank"><img src={HeaderLink2} alt="Header link 2" /></a> {/* Change later link is not right */}
                    <a href="https://t.me/Sanduhh" target="_blank"><img src={HeaderLink3} alt="Header link 3" /></a> {/* Change later link is not right */}
                </div>
            </div>
